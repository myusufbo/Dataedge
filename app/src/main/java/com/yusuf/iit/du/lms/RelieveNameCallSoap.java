 ...
 */
public class RelieveNameCallSoap {
    public final String SOAP_ACTION="http://tempuri.org/GetReleaverByDept";

    public  final String OPERATION_NAME = "GetReleaverByDept";

    public  final String WSDL_TARGET_NAMESPACE = "http://tempuri.org/";

    public  final String SOAP_ADDRESS = "http://192.168.2.116/LAPSAdminWebService/SecAdminService.asmx";
    public RelieveNameCallSoap (){

    }
    public String Call(String DeptId ) {
