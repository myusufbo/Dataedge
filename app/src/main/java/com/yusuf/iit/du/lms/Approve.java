...
public class Approve extends ActionBarActivity {
    ...
    private void initDrawer(Bundle savedInstanceState) {
        ...
        final Toolbar toolbar = (Toolbar) findViewById(R.id.approveToolbar);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            ...
                            if (drawerItem.getIdentifier() == 0) {
                                ...
                                startActivity(new Intent(Approve.this, Home.class));
//                                Toast.makeText(getBaseContext(), "On Drawer Created", Toast.LENGTH_LONG).show();

                            } else if (drawerItem.getIdentifier() == 1) {
                                //fragment = new Calculator();
                                 startActivity(new Intent(Approve.this,LeaveApply.class));
...
//                                 startActivity(new Intent(HealthCalculator.this, MotherHealth.class));
                                ...
                                startActivity(new Intent(Approve.this, Relieve.class));
                                 ...
                                 startActivity(new Intent(Approve.this, Myleave.class));
