...
public class Relieve extends ActionBarActivity {
    ...
    private void initDrawer(Bundle savedInstanceState) {
        ...
        final Toolbar toolbar = (Toolbar) findViewById(R.id.relieveToolbar);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            ...
                            if (drawerItem.getIdentifier() == 0) {
                                ...
                                startActivity(new Intent(Relieve.this, Home.class));
//                                Toast.makeText(getBaseContext(), "On Drawer Created", Toast.LENGTH_LONG).show();
//
                            } else if (drawerItem.getIdentifier() == 1) {
                                //fragment = new Calculator();
                                 startActivity(new Intent(Relieve.this,LeaveApply.class));


                            } else if (drawerItem.getIdentifier() == 2) {

                                 startActivity(new Intent(Relieve.this, Approve.class));
                            }
                            else if (drawerItem.getIdentifier() == 3) {

                                //startActivity(new Intent(HealthCalculator.this, ChildHealth.class));
                            } else if (drawerItem.getIdentifier() == 4) {
                                 startActivity(new Intent(Relieve.this, Myleave.class));
                            } else if (drawerItem.getIdentifier() == 5) {
                                startActivity(new Intent(Relieve.this, MainActivity.class));
//                                finish();
...
//        getSupportActionBar().setHomeButtonEnabled(false);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_relieve, menu);
        return true;
    }
